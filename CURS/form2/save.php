...
<html lang="en">
	...
	<?php
		...
		<div class="main">
			...
			<div class="asd">
				<p <?php if($save4) { echo 'style="color:green;"'; } else { echo 'style="color:red;"'; }?>>
				Año:<?php echo $year;?></p>
			</div>
			<div class="asd">	
				<p <?php if($save5) { echo 'style="color:green;"'; } else { echo 'style="color:red;"'; }?>>
				Lenguaje:<?php echo $language;?></p>
			</div>
			<div class="asd">
				<p <?php if($save6) { echo 'style="color:green;"'; } else { echo 'style="color:red;"'; }?>>
				Terminos:<?php echo $terminos;?></p>
			</div>
			<div class="asd">	
				<p <?php if($save7) { echo 'style="color:green;"'; } else { echo 'style="color:red;"'; }?>>
				Condiciones:<?php echo $condiciones;?></p>
			</div>
			<div class="asd">
				<p <?php if($save8) { echo 'style="color:green;"'; } else { echo 'style="color:red;"'; }?>>
